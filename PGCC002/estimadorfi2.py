...
def segmentador(executar, imagem, cor, projeto_id, projeto_nome, imagem_id, imagem_nome, anotacao_id, estima_fi_humano, parametros):
    if(executar):
        ...
        coreshsv = OrderedDict({
            "Vermelho1": ([0, 80, 90], [15, 255, 255]),
            "Vermelho2": ([165, 80, 90], [180, 255, 255]),      # 180
            "Verde": ([45, 80, 90], [75, 255, 255]),            # 60
            "Azul": ([105, 80, 90], [135, 255, 255])            # 120
        })
        if cor == 0:
            minimo, maximo = coreshsv["Vermelho1"]
        elif cor == 1:
        ...
        # exibir imagens
        plt_imagens(False, img_rgb, mascara, sobreposicao,
                    segmentacao, resultadoFI, projeto_id, projeto_nome, imagem_id, imagem_nome, anotacao_id)

        return str(resultadoFI)+'%'
    ### FIM método segmentador de imagem na escala de cor HSV ##########################


def plt_imagens(executar, imagen, mascara, sobreposicao, segmentacao, resultado, projeto_id, projeto_nome, imagem_id, imagem_nome, anotacao_id):
    if(executar):
        # imagens e respectivos titulos
        imagens = [imagen.copy(),
                   mascara.copy(),
...
>>>>>>>> 24298f911e7726b6f2d9b45e184de44392b0c6e2:PGCC002/estimadorfi.py
